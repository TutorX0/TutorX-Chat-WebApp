...
export function FileMessage({ phoneNumber, setMessage }: FileMessageProps) {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent align="start" className="w-full">
                <SendFiles fileType="image_videos" phoneNumber={phoneNumber}>
                    <div className="flex cursor-pointer items-center gap-2 pt-1 pb-2 text-sm">
                        <ImageIcon className="size-5" />
                        <span>Photos & videos</span>
                    </div>
                </SendFiles>
                <SendFiles fileType="documents" phoneNumber={phoneNumber}>
