export const googleMeetMessage = `📞 Scheduled Google Meet Session

🔗 Join the Meeting: https://meet.google.com/pkh-avop-eiy
...
📌 Note: Kindly share a screenshot of the payment for instant verification.
