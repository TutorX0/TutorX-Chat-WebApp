...
export function PhotoMessage({ sentBy }: PhotoMessageProps) {
    let caption =
    ...
    return (
        <MessageOptions textToCopy={caption}>
            ...
            >
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit, deserunt rerum! Eaque amet ad facere quaerat,
                    dicta totam, quo eum excepturi expedita architecto eius qui quidem fugit fuga modi sint.
                </p>
