export function LoginLogo() {
    return (
        <svg viewBox="0 0 72 54" height="54" width="72" preserveAspectRatio="xMidYMid meet" className="shrink-0" fill="none">
            ...
            <g clipPath="url(#a)">
                ...
                <path
                    ...
                    strokeWidth="1.5"
                    strokeMiterlimit="10"
                    style={{ fill: "color(display-p3 0.902 1 0.8549)", stroke: "color(display-p3 0.0667 0.1059 0.1294)" }}
                ></path>
                <path
                ...
                <rect
                    ...
                    strokeWidth="1.5"
                    strokeMiterlimit="10"
                    style={{ fill: "color(display-p3 0.9882 0.9608 0.9216)", stroke: "color(display-p3 0.0667 0.1059 0.1294)" }}
                ></rect>
                <path
                    ...
                    style={{ fill: "color(display-p3 0.1451 0.8275 0.4)", stroke: "color(display-p3 0.0667 0.1059 0.1294)" }}
                ></path>
            </g>
            <defs>
                <clipPath id="a">
